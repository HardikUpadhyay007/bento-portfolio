...
export const PostgreSQLSVG = ({ color = "#336791", size = 16 }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 32 32"
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <ellipse cx="16" cy="16" rx="16" ry="16" fill={color} />
        <path
            d="M22.5 21.5c-1.5 1-3.5 1.5-6.5 1.5s-5-0.5-6.5-1.5c-1.5-1-2-2.5-2-4.5s0.5-3.5 2-4.5c1.5-1 3.5-1.5 6.5-1.5s5 0.5 6.5 1.5c1.5 1 2 2.5 2 4.5s-0.5 3.5-2 4.5z"
            stroke="#fff"
            strokeWidth="2"
            fill="none"
        />
        <ellipse cx="13" cy="16" rx="1" ry="2" fill="#fff" />
        <ellipse cx="19" cy="16" rx="1" ry="2" fill="#fff" />
    </svg>
);
...
export const PrimeReactSVG = ({ color, size }: IconType) => {
    return (
        ...
        >
            ...
            <g mask="url(#mask0_2642_813)" fill="none">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
